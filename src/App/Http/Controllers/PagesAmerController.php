...
class PagesAmerController extends AmerController
{
    ...
    public function setup()
    {
        ...
        if(amer_user()->can('Pages-add') == 0){$this->Amer->denyAccess('create');}
        if(amer_user()->can('Pages-trash') == 0){$this->Amer->denyAccess ('trash');}
        if(amer_user()->can('Pages-update') == 0){$this->Amer->denyAccess('update');}
        if(amer_user()->can('Pages-delete') == 0){$this->Amer->denyAccess('delete');}
        if(amer_user()->can('Pages-show') == 0){$this->Amer->denyAccess('show');}
        */
    }
